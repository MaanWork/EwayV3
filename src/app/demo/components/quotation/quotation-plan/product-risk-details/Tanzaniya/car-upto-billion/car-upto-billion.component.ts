...
@Component({
  selector: 'car-upto-billion',
  templateUrl: './car-upto-billion.component.html',
  styleUrl: './car-upto-billion.component.scss'
})
export class CarUptoBillionComponent {
    userType: any = null;
      productId: any = null;
      form2 = new FormGroup({});
  ...
  showMaxLimitError: boolean;
      constructor(private sharedService: SharedService){
        ...
        this.branchCode = this.userDetails.Result.BranchCode;
        let fireData = null;
        if (this.productId == '82') { fireData = new ConstructionAllRiskUptoTanzaniya(); }
