...
export class OfficeContentsCommercialMozambique{
  customerDetails: any;
  commonDetails: any[] = [];
              ...
              fieldGroup: [
                {
                  fieldGroup: [
                    ...
                    { props: { label: `Description` }, className: "col-6" },
                  ...
                  fieldGroup: [
                    ...
                    },
                    {
                      fieldGroup: [
...

                        {
                          className: "mt-1",
                          type: 'commaSeparator',
                          key: 'OfficePowerSurge',

                          templateOptions: {
                            disabled: this.checkDisable('OfficePowerSurge'),
                            maxLength: 15,
                            required: false,
                            options: [
                    ...
                    },
                    {
                      fieldGroup: [
                        ...
                        {
                          className: "mt-1 rightAlign no-top table-drop-padding",
                          type: 'ngselect',
