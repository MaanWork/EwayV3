...
export class StateBenefitsCommercialSwaziland {
  customerDetails: any;
  ...
  constructor() {
    ...
    this.policyfields1 = {
      fieldGroup: [
        ...
        {
          key: 'TemporaryTotalDisabilitySB',
          type: 'ngselect',
          props: {
        ...
        {
          key: 'PermanentTotalDisabilitySB',
          type: 'commaSeparator',
          props: {
  ...
  // getSwazilandListItem(type,sectionType):any{
  //   let ReqObj = {
