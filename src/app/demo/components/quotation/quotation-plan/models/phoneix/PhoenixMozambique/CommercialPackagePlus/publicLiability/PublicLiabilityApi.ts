...
export class PublicLiabilityCommercialApiMozambique{
    customerDetails: any;
    commonDetails: any[]=[];
  ...
  extendsfields:FormlyFieldConfig
    ...
    getEditDetails(subDetails,obj){
      ...
      if (PublicLiabilityPhoenix.length != 0) {
        ...
        if (AdditionalclaimsPreparationCostsList.length != 0) { obj['AdditionalclaimsPreparationCosts'] = AdditionalclaimsPreparationCostsList[0].CategoryId; }
