...
export class PublicLiabilityApiMozambique{
  customerDetails: any;
  commonDetails: any[]=[];
  ...
  getSaveDetails(entry,GeneralLiabilityList,LiabilityLegalList,ArrestList,IndustryId,industryTypeList,obj){
      if (entry.GeneralLiability != null && entry.GeneralLiability != 0 && entry.GeneralLiability != '0') {
       ...
       if (entry.WrongfulArrestandDefamation != null && entry.WrongfulArrestandDefamation != 0 && entry.WrongfulArrestandDefamation != '0') {
        ...
        if (entry.ProductsLiability != null && entry.ProductsLiability != 0 && entry.ProductsLiability != '0' && entry.ProductsLiability != 'undefined' && entry.ProductsLiability != undefined && entry.ProductsLiabilityRevenue != null && entry.ProductsLiabilityRevenue != 0 && entry.ProductsLiabilityRevenue != '0' && entry.ProductsLiabilityRevenue != 'undefined' && entry.ProductsLiabilityRevenue != undefined) {
          let subEntry = {
          "SectionId": "54",
      ...
      if (entry.DefectiveWorkmanship != null && entry.DefectiveWorkmanship != 0 && entry.DefectiveWorkmanship != '0' && entry.DefectiveWorkmanship != 'undefined' && entry.DefectiveWorkmanship != undefined && entry.DefectiveWorkmanshipRevenue != null && entry.DefectiveWorkmanshipRevenue != 0 && entry.DefectiveWorkmanshipRevenue != '0' && entry.DefectiveWorkmanshipRevenue != 'undefined' && entry.DefectiveWorkmanshipRevenue != undefined) {
          let subEntry = {
          "SectionId": "54","SectionName": "Public Liabilty",
          "CoverId": "437",
