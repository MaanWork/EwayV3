                ...
                fieldGroup: [
                  {
                    ...
                    id: 'InsuranceType',
                    defaultValue: '',
                    className: 'col-12 md:col-4 lg:col-4 xl:col-4 pl-2 pr-2 pt-1 mt-2',
                    props: {
                      label: `InsuranceType`,
                  ...
                  //   id: 'MotorUsage',
                  //   defaultValue: '',
                  //   className: 'col-12 md:col-4 lg:col-4 xl:col-4 mt-2',
                  //   props: {
                  //     label: `Motor Usage`,
                  ...
                  {
                    className: 'col-12 md:col-4 lg:col-4 xl:col-4 -mt-1',
                    type: 'commaSeparator',
                    key: 'VehicleSI',
                    id: 'VehicleSI',
                    hide: true,
