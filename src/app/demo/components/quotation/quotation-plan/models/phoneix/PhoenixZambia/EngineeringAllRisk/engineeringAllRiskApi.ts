...
export class EngineeringAllRiskApiPhoenix{
    customerDetails: any;
    commonDetails: any[]=[];
    ...
    getEditDetails(subDetails,obj,info){
        let CARSection  = subDetails.filter(ele=>ele['SectionId']=='233');    
                            if(CARSection.length!=0){
                              ...
                              if(CARDemolition.length!=0){obj['CARDemolition']=CARDemolition[0].SumInsured;obj['IndustryType']=null;obj['BuildingBuildYear']=CARDemolition[0].BuildingBuildYear;if(CARDemolition[0]?.IndustryType!='0')obj['IndustryType']=CARDemolition[0].IndustryType;}
                              let CARProfessional = CARSection.filter(ele=>ele.CoverId==556|| ele.CoverId=='556')
                              if(CARProfessional.length!=0){obj['CARProfessional']=CARProfessional[0].SumInsured;obj['IndustryType']=null;obj['BuildingBuildYear']=CARProfessional[0].BuildingBuildYear;if(CARProfessional[0]?.IndustryType!='0')obj['IndustryType']=CARProfessional[0].IndustryType;}
                              let CAREscalation = CARSection.filter(ele=>ele.CoverId==569|| ele.CoverId=='569')
                              if(CAREscalation.length!=0){obj['CAREscalation']=CAREscalation[0].SumInsured;obj['IndustryType']=null;obj['BuildingBuildYear']=CAREscalation[0].BuildingBuildYear;if(CAREscalation[0]?.IndustryType!='0')obj['IndustryType']=CAREscalation[0].IndustryType;} 
                              let CARDevaluation = CARSection.filter(ele=>ele.CoverId==567|| ele.CoverId=='567')
                              if(CARDevaluation.length!=0){obj['CARDevaluation']=CARDevaluation[0].SumInsured;obj['IndustryType']=null;obj['BuildingBuildYear']=CARDevaluation[0].BuildingBuildYear;if(CARDevaluation[0]?.IndustryType!='0')obj['IndustryType']=CARDevaluation[0].IndustryType;}
                              let CARClaimPreparation = CARSection.filter(ele=>ele.CoverId==367|| ele.CoverId=='367')
                              if(CARClaimPreparation.length!=0){obj['CARClaimPreparation']=CARClaimPreparation[0].SumInsured;obj['IndustryType']=null;obj['BuildingBuildYear']=CARClaimPreparation[0].BuildingBuildYear;if(CARClaimPreparation[0]?.IndustryType!='0')obj['IndustryType']=CARClaimPreparation[0].IndustryType;}
                              let CARSurrounding = CARSection.filter(ele=>ele.CoverId==557|| ele.CoverId=='557')
                              if(CARSurrounding.length!=0){obj['CARSurrounding']=CARSurrounding[0].SumInsured;obj['IndustryType']=null;obj['BuildingBuildYear']=CARSurrounding[0].BuildingBuildYear;if(CARSurrounding[0]?.IndustryType!='0')obj['IndustryType']=CARSurrounding[0].IndustryType;}
