    ...
    getEditDetails(subDetails,obj,BIValue,EValue,showInterruptions,showExtensionToggle,showExtensions){
      let BuildingList  = subDetails.filter(ele=>ele['SectionId']=='1');
                      if(BuildingList.length!=0){
                          ...
                          if(contentsList.length!=0){obj['contents'] = contentsList[0].SumInsured;obj['contentsDesc'] = contentsList[0].DescriptionOfRisk;obj['IndustryType'] = contentsList[0]?.IndustryType;}
                              let GeyserSolarList  = subDetails.filter(ele=>ele['SectionId']=='196' && ele['CoverId']==488);
                          if(GeyserSolarList.length!=0){obj['GeyserSolar'] = GeyserSolarList[0].SumInsured;obj['GeyserSolarDesc'] = GeyserSolarList[0].DescriptionOfRisk;obj['IndustryType'] = GeyserSolarList[0]?.IndustryType;}
                              let GeyserInhouseList  = subDetails.filter(ele=>ele['SectionId']=='196' && ele['CoverId']==364);
                          if(GeyserInhouseList.length!=0){obj['GeyserInhouse'] = GeyserInhouseList[0].SumInsured;obj['GeyserInhouseDesc'] = GeyserInhouseList[0].DescriptionOfRisk;obj['IndustryType'] = GeyserInhouseList[0]?.IndustryType;}
                      let machineryList  = subDetails.filter(ele=>ele['SectionId']=='185' && ele['CoverId']==353);
                      if(machineryList.length!=0){obj['plantMachinery'] = machineryList[0].SumInsured;obj['plantMachineryDesc'] = machineryList[0].DescriptionOfRisk;obj['IndustryType'] = machineryList[0]?.IndustryType;}
                      let stockList  = subDetails.filter(ele=>ele['SectionId']=='186' && ele['CoverId']==354);
                      if(stockList.length!=0){obj['stockInTrade'] = stockList[0].SumInsured;obj['stockInTradeDesc'] = stockList[0].DescriptionOfRisk;obj['IndustryType'] = stockList[0]?.IndustryType;}
                      let miscellaneousList  = subDetails.filter(ele=>ele['SectionId']=='187' && ele['CoverId']==355);
                      if(miscellaneousList.length!=0){obj['miscellaneous'] = miscellaneousList[0].SumInsured;obj['miscellaneousDesc'] = miscellaneousList[0].DescriptionOfRisk;obj['IndustryType'] = miscellaneousList[0]?.IndustryType;}
                      let powerSurgeList  = subDetails.filter(ele=>ele['SectionId']=='188' && ele['CoverId']==356);
                      if(powerSurgeList.length!=0){obj['powerSurge'] = powerSurgeList[0].SumInsured;obj['powerSurgeDesc'] = powerSurgeList[0].DescriptionOfRisk;obj['IndustryType'] = powerSurgeList[0]?.IndustryType;}
                      let hailDamageList  = subDetails.filter(ele=>ele['SectionId']=='190' && ele['CoverId']==358);
                      if(hailDamageList.length!=0){obj['hailDamage'] = hailDamageList[0].SumInsured;obj['hailDamageDesc'] = hailDamageList[0].DescriptionOfRisk;obj['IndustryType'] = hailDamageList[0]?.IndustryType;}
                      let rentReceivableList  = subDetails.filter(ele=>ele['SectionId']=='191' && ele['CoverId']==359);
                      if(rentReceivableList.length!=0){obj['rentReceivable'] = rentReceivableList[0].SumInsured;obj['rentReceivableDesc'] = rentReceivableList[0].DescriptionOfRisk;obj['IndustryType'] = rentReceivableList[0]?.IndustryType;}
                      let leakageExtensionList  = subDetails.filter(ele=>ele['SectionId']=='189' && ele['CoverId']==357);
                      if(leakageExtensionList.length!=0){obj['leakageExtension'] = leakageExtensionList[0].CategoryId;obj['leakageExtensionDesc'] = leakageExtensionList[0].DescriptionOfRisk;obj['leakageExtensionSumInsured'] = leakageExtensionList[0].SumInsured;obj['leakageExtensionSumInsuredDesc'] = leakageExtensionList[0].DescriptionOfRisk;obj['IndustryType'] = leakageExtensionList[0]?.IndustryType;}
                      let finalObj = {
                          "Obj":obj,
                          "EValue":EValue,
                          "BIValue":BIValue,
    ...
    getSaveDetails(entry,IndustryId,industryTypeList,obj){
      if(entry.plantMachinery!=null && entry.plantMachinery!='' && entry.plantMachinery!='' && entry.plantMachinery!='null'){
        ...
        sectionId='1';
          let subEntry={
            ...
            "CoverId": "353",
            "DescriptionOfRisk": entry.plantMachineryDesc
          }
      ...
      if(entry.stockInTrade!=null && entry.stockInTrade!='' && entry.stockInTrade!='null'){
        ...
        let subEntry={
          ...
          "DescriptionOfRisk": entry.stockInTradeDesc
        }
        if(IndustryId){subEntry['IndustryType'] = IndustryId;subEntry["IndustryTypeDesc"]= industryTypeList.find(ele=>ele.Code==IndustryId)?.CodeDesc}
        obj.SectionList.push(subEntry);
        }
      if(entry.miscellaneous!=null && entry.miscellaneous!='' && entry.miscellaneous!='null'){
          ...
          let subEntry={
            ...
            "DescriptionOfRisk": entry.miscellaneousDesc
          }
          if(IndustryId){subEntry['IndustryType'] = IndustryId;subEntry["IndustryTypeDesc"]= industryTypeList.find(ele=>ele.Code==IndustryId)?.CodeDesc}
          obj.SectionList.push(subEntry);
      }
                  if(entry.hailDamage!=null && entry.hailDamage!='' && entry.hailDamage!='null'){
                      let subEntry={
                        ...
                        "CoverId": "358",
                        "DescriptionOfRisk": entry.hailDamageDesc
                      }
                      if(IndustryId){subEntry['IndustryType'] = IndustryId;subEntry["IndustryTypeDesc"]= industryTypeList.find(ele=>ele.Code==IndustryId)?.CodeDesc}
                      obj.SectionList.push(subEntry);
                    }
                    ...
                    if(entry.rentReceivable!=null && entry.rentReceivable!='' && entry.rentReceivable!='null'){
                      let subEntry={
                        ...
                        "CoverId": "359",
                        "DescriptionOfRisk": entry.rentReceivableDesc
                      }
                      if(IndustryId){subEntry['IndustryType'] = IndustryId;subEntry["IndustryTypeDesc"]= industryTypeList.find(ele=>ele.Code==IndustryId)?.CodeDesc}
                      obj.SectionList.push(subEntry);
                    }
                  if(entry.leakageExtension!=null && entry.leakageExtension!='' && entry.leakageExtensionSumInsured!=null && entry.leakageExtensionSumInsured!='0' && entry.leakageExtensionSumInsured!='null'){
                      let subEntry={
                        ...
                        "DescriptionOfRisk": entry.leakageExtensionDesc
                      }
                      if(IndustryId){subEntry['IndustryType'] = IndustryId;subEntry["IndustryTypeDesc"]= industryTypeList.find(ele=>ele.Code==IndustryId)?.CodeDesc}
                      obj.SectionList.push(subEntry);
                  }
                  if(entry.ConstructionType!=null && entry.ConstructionType!='' && entry.fireBuildingSumInsured!=null && entry.fireBuildingSumInsured!='' && entry.fireBuildingSumInsured!='null'){
                    ...
                    if(entry.contents!=null && entry.contents!='' && entry.contents!='null' ){
                        ...
                        let subEntry={
                          ...
                          "CategoryId": entry.ConstructionType,
                          "CoverId": "290",
                          "DescriptionOfRisk":entry.contentsDesc
                        }
                        if(IndustryId){subEntry['IndustryType'] = IndustryId;subEntry["IndustryTypeDesc"]= industryTypeList.find(ele=>ele.Code==IndustryId)?.CodeDesc}
                        obj.SectionList.push(subEntry);
                    }
                    if(entry.GeyserSolar!=null && entry.GeyserSolar!='' && entry.GeyserSolar!='null' ){
                      ...
                      sectionId='1';
                        let subEntry={
                          ...
                          "CategoryId": entry.ConstructionType,
                          "CoverId": "488",
                          "DescriptionOfRisk":entry.GeyserSolarDesc
                        }
                        if(IndustryId){subEntry['IndustryType'] = IndustryId;subEntry["IndustryTypeDesc"]= industryTypeList.find(ele=>ele.Code==IndustryId)?.CodeDesc}
                        obj.SectionList.push(subEntry);
                    }
                    if(entry.GeyserInhouse!=null && entry.GeyserInhouse!='' && entry.GeyserInhouse!='null'){
                      ...
                      sectionId='1';
                        let subEntry={
                          ...
                          "CategoryId": entry.ConstructionType,
                          "CoverId": "364",
                          "DescriptionOfRisk":entry.GeyserInhouseDesc
                        }
                        if(IndustryId){subEntry['IndustryType'] = IndustryId;subEntry["IndustryTypeDesc"]= industryTypeList.find(ele=>ele.Code==IndustryId)?.CodeDesc}
                        obj.SectionList.push(subEntry);
                    }
