            ...
            fieldGroup: [
                ...
                fieldGroup: [
                  ...
                  },
                  {
                    ...
                    templateOptions: {
                      ...
                      placeholder: '-Select-',
                      required: true,
                      disabled: this.checkDisable('IndustryType'),
                      maxLength: 15,
                      options:[]
                    },
                  ...
                  },
                  {
                    ...
                    templateOptions: {
                      ...
                      placeholder: '-Select-',
                      required: true,
                      disabled: this.checkDisable('WealthSource'),
                      maxLength: 15,
                      options:[]
                    },
                  ...
                  },
                  {
                    ...
                    templateOptions: {
                      ...
                      required: true,
                      disabled: this.checkDisable('LandLineNo'),
                      maxLength: 10
                    },
                    validators: {
                    },
              ...
              },
              {
                ...
                fieldGroup: [
                  ...
                  //     placeholder: '-Select-',
                  //     required: true,
                  //     disabled: this.checkDisable('CustomerTypes'),
                  //     maxLength: 15,
                  //     options:[]
                  //   },
                  ...
                  // },
                    ...
                    hideExpression:false,
                    templateOptions: {
                      label: `Complience Status`,
                      placeholder: '-Select-',
                      required: true,
                      disabled: this.checkDisable('ComplianceStatus'),
                      maxLength: 15,
                      options:[]
                    },
                  ...
                  },
                  {
                    ...
                    templateOptions: {
                      ...
                      placeholder: '-Select-',
                      required: true,
                      disabled: this.checkDisable('LegalStructure'),
                      maxLength: 15,
                      options:[]
                    },
                  ...
                  },
                  {
                    ...
                    templateOptions: {
                      ...
                      placeholder: '-Select-',
                      required: true,
                      disabled: this.checkDisable('Owners'),
                      maxLength: 15,
                      options:[]
                    },
