...
export class PublicLiabilityCommercialApiNamibia{
    customerDetails: any;
    commonDetails: any[]=[];
  ...
  extendsfields:FormlyFieldConfig
    ...
    getEditDetails(subDetails,obj){
      ...
      if (PublicLiabilityPhoenix.length != 0) {
        ...
        if (AdditionalclaimsPreparationCostsList.length != 0) { obj['AdditionalclaimsPreparationCosts'] = AdditionalclaimsPreparationCostsList[0].CategoryId || AdditionalclaimsPreparationCostsList[0].SumInsured; }
        ...
        obj['filled'] = PublicLiabilityPhoenix.length > 0 ? true: false
        return obj
      }
    }
    getSaveDetails(entry,GeneralLiabilityList,LiabilityLegalList,ArrestList,IndustryId,industryTypeList,obj, ExtendsList){
        if (entry.GeneralLiability != null && entry.GeneralLiability != 0 && entry.GeneralLiability != '0') {
          ...
          console.log('subEntrygeneral', subEntry)
         ...
         if (entry.CarWashandValetExtension != null && entry.CarWashandValetExtension != 0 && entry.CarWashandValetExtension != '0' && entry.CarWashandValetExtension != 'undefined') {
          let subEntry = {
            "SectionId": "54","SectionName": "Public Liabilty",
            "CoverId": "443",
         ...
         if (entry.AdditionalclaimsPreparationCosts != null && entry.AdditionalclaimsPreparationCosts != 0 && entry.AdditionalclaimsPreparationCosts != '0' && entry.AdditionalclaimsPreparationCosts != undefined && entry.AdditionalclaimsPreparationCosts != 'undefined') {
          console.log("claimCostList",ExtendsList,entry.AdditionalclaimsPreparationCosts);
          
          let SI = ExtendsList.find(ele=>String(ele.CodeDesc).replaceAll(',','')==entry.AdditionalclaimsPreparationCosts)?.Code;
