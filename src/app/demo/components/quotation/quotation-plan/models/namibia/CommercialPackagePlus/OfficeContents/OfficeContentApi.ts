  ...
  extendsfields:FormlyFieldConfig
    ...
    getEditDetails(subDetails,obj){
       ...
       if(OfficeContentSection.length!=0){
        ...
        obj['filled'] = OfficeContentSection.length > 0 ? true: false
          return obj
      }
    }
    getSaveDetails(entry,ClaimCostList,IndustryId,industryTypeList,obj){
      if (entry.OfficeContents != 0 && entry.OfficeContents != null && entry.OfficeContents != '' && entry.OfficeContentsDesc != null && entry.OfficeContentsDesc != '') {
        ...
        if (entry.OfficePowerSurge != null && entry.OfficePowerSurge != 0 && entry.OfficePowerSurge != '0' && entry.OfficePowerSurge != 'null' && entry.OfficePowerSurge != 'undefined') {
          let subEntry = {
            "SectionId": "198","SectionName":"Office Contents",
            "CoverId": "356",
