...
export class FireNamibiaCommercialApi{
  ...
  extendsfields:FormlyFieldConfig
    ...
    getEditDetails(subDetails,obj,BIValue,EValue,showInterruptions,showExtensionToggle,showExtensions){
      let BuildingList  = subDetails.filter(ele=>ele['SectionId']=='4');
                      if(BuildingList.length!=0){
                          ...
                          let grossRenewalsList = BuildingList.filter(ele=>ele.CoverId=='493' || ele.CoverId==493);
                            ...
                            if(AccidentalDamageList.length!=0){
                              ...
                              obj['AccidentalSumInsured']=AccidentalDamageList[0].SumInsured;
                            }
                            ...
                            if(PublicUtilitiesSI.length!=0){
                              BIValue='Y';EValue='Y';showExtensions=true;showInterruptions = true;showExtensionToggle=true;
                              obj['PublicUtilitiesSI']=PublicUtilitiesSI[0].SumInsured;obj['PublicUtilities']=PublicUtilitiesSI[0].CategoryId;
                            }
                            ...
                            let contentsList  = BuildingList.filter(ele=>ele['CoverId']=='290' || ele['CoverId']==290);
                            if(contentsList.length!=0){obj['firecontents'] = contentsList[0].SumInsured;obj['IndustryType'] = contentsList[0]?.IndustryType;}
                              console.log(contentsList);
                            let GeyserSolarList  = BuildingList.filter(ele=>ele['CoverId']=='488' || ele['CoverId']==488);
                            if(GeyserSolarList.length!=0){obj['GeyserSolar'] = GeyserSolarList[0].SumInsured;obj['IndustryType'] = GeyserSolarList[0]?.IndustryType;}
                            let GeyserInhouseList  = BuildingList.filter(ele=>ele['CoverId']=='364' || ele['CoverId']==364);
                            ...
                            let leakageExtensionList  = BuildingList.filter(ele=>ele['CoverId']=='357' || ele['CoverId']==357);
    ...
    getSaveDetails(entry,IndustryId,industryTypeList,obj){
      console.log(entry);
      if(entry.plantMachinery!=null && entry.plantMachinery!=''  && entry.plantMachinery!='null' && entry.plantMachinery!='0'){
        let sectionId=null;
        sectionId='1';
          let subEntry={
            "SectionId": "4","SectionName":"Fire",
      ...
      if(entry.stockInTrade!=null && entry.stockInTrade!='' && entry.stockInTrade!='null' && entry.stockInTrade!='0'){
        let sectionId=null;
        sectionId='1';
        let subEntry={
          "SectionId": "4","SectionName":"Fire",
      ...
      if(entry.miscellaneous!=null && entry.miscellaneous!='' && entry.miscellaneous!='null' && entry.miscellaneous!='0'){
                let sectionId=null;
                sectionId='1';
                let subEntry={
                  "SectionId": "4","SectionName":"Fire",
                ...
                obj.SectionList.push(subEntry);
                  ...
                  if(entry.hailDamage!=null && entry.hailDamage!='' && entry.hailDamage!='null' && entry.hailDamage!='0'){
                      let subEntry={
                        "SectionId":"4","SectionName": "Fire",
                    ...
                    if(entry.rentReceivable!=null && entry.rentReceivable!='' && entry.rentReceivable!='null' && entry.rentReceivable!='0'){
                      let subEntry={
                        "SectionId":"4","SectionName": "Fire",
                        "Status":"Y","SumInsured":entry.rentReceivable,
                        "CoverId": "359","DescriptionOfRisk": null
                      }
                      if(IndustryId){subEntry['IndustryType'] = IndustryId;subEntry["IndustryTypeDesc"]= industryTypeList.find(ele=>ele.Code==IndustryId)?.CodeDesc}
                      obj.SectionList.push(subEntry);
                    }
                  ...
                  if(entry.ConstructionType!=null && entry.ConstructionType!='' && entry.fireBuildingSumInsured!=null && entry.fireBuildingSumInsured!='' && entry.fireBuildingSumInsured!='null' && entry.fireBuildingSumInsured!='0'){
                      let subEntry={
                        "SectionId":"4","SectionName": "Fire",
                    ...
                    if(entry.AdditonalInflation!=null && entry.AdditonalInflation!='' && entry.fireBuildingSumInsured!=null && entry.fireBuildingSumInsured!='' && entry.fireBuildingSumInsured!='null' && entry.fireBuildingSumInsured!='0'){
                      let subEntry={
                        "SectionId":"4","SectionName": "Fire",
                        "Status":"Y","SumInsured":entry.fireBuildingSumInsured,
                        "CoverId": "360",
                    ...
                    if(entry.PreventionofAccess!=null && entry.PreventionofAccess!='' && entry.PreventionofAccess!='0'  && entry.PreventionofAccess!='null' && entry.PreventionofAccess!='undefined'){
                      let subEntry={
                        "SectionId":"4","SectionName":"Fire",
                    ...
                    if(entry.PublicTelecommuncationSI!=null && entry.PublicTelecommuncationSI!='' && entry.PublicTelecommuncationSI!='0' && entry.PublicTelecommuncation!=null && entry.PublicTelecommuncation!=''  && entry.PreventionofAccessSI!='null'){
                      let subEntry={
                        "SectionId":"4","SectionName":"Fire",
                    ...
                    if(entry.PublicUtilitiesSI!=null && entry.PublicUtilitiesSI!='' && entry.PublicUtilitiesSI!='0' && entry.PublicUtilities!=null && entry.PublicUtilities!=''  && entry.PreventionofAccessSI!='null'){
                      let subEntry={
                        "SectionId":"4","SectionName":"Fire",
                    ...
                    if(entry.firecontents!=null && entry.firecontents!=''  && entry.firecontents!='null' && entry.firecontents!='undefined' && entry.firecontents!=undefined && entry.firecontents!="[object Object]" && entry.firecontents!="0"){
                      let sectionId=null;
                      sectionId='1';
                        let subEntry={
                          "SectionId":"4","SectionName": "Fire",
                          "Status":"Y","SumInsured":entry.firecontents.replace(/,/g, ''),
                          "CategoryId": entry.ConstructionType,
                          "CoverId": "290",
                          "DescriptionOfRisk":null
                        }
                    ...
                    if(entry.GeyserSolar!=null && entry.GeyserSolar!='' && entry.GeyserSolar!='null' && entry.GeyserSolar!='0' ){
                      let sectionId=null;
                      sectionId='1';
                        let subEntry={
                          "SectionId": "4","SectionName":"Geyser",
                    ...
                    if(entry.GeyserInhouse!=null && entry.GeyserInhouse!='' && entry.GeyserInhouse!='null' && entry.GeyserInhouse!='0' ){
                      let sectionId=null;
                      sectionId='1';
                        let subEntry={
                          "SectionId": "4","SectionName":"Geyser",
                    ...
                    if(entry.CustomerSupplierSI!=null && entry.CustomerSupplierSI!='' && entry.CustomerSupplierSI!='0' && entry.CustomerSupplier!=null && entry.CustomerSupplier!='' && entry.CustomerSupplier!='null'){
                      let subEntry={
                        "SectionId":"4","SectionName":"Building",
                    ...
                    if(entry.AccidentalSumInsured!=null && entry.AccidentalSumInsured!='' && entry.AccidentalSumInsured!='0' && entry.AccidentalSumInsured!='null'){
                      let subEntry={
                        "SectionId":"4","SectionName":"Building",
                        "Status":"Y","SumInsured":entry.AccidentalSumInsured,
                        "CoverId": "156",
                        "DescriptionOfRisk": null
                      }
                      if(IndustryId){subEntry['IndustryType'] = IndustryId;subEntry["IndustryTypeDesc"]= industryTypeList.find(ele=>ele.Code==IndustryId)?.CodeDesc}
