...
export class CashInTransitApiNamibia {
    ...
    getEditDetails(subDetails, obj) {
        ...
        if (cashInTransit.length != 0) {
            ...
            else{obj['cashStaticTransit'] =null}
            ...
            else{ obj['cashVehicleTransit'] =null}
            ...
            if (cashPavementCarry.length != 0) { obj['cashPavementCarry'] = cashPavementCarry[0].SumInsured; }
             else{ obj['cashPavementCarry'] =null}
            ...
            else{ obj['cashSafeVault'] =null}
            obj['filled'] = cashInTransit.length > 0 ? true: false
            return obj
        }
    }
