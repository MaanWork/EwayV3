...
export class HouseOwnerPersonalApiNamibia{
    customerDetails: any;
    commonDetails: any[]=[];
  ...
  extendsfields:FormlyFieldConfig
    ...
    getEditDetails(subDetails,obj){
      ...
      if (HouseOwnerPhoenix.length != 0) {
        ...
        if (buildingList.length != 0) { obj['BuildingSumInsuredFullcover'] = buildingList[0].SumInsured;obj['NoClaimBonus'] = buildingList[0].NoOfClaim; obj['BuildingSumInsuredFullcoverDesc'] = buildingList[0].DescriptionOfRisk; }
        ...
        console.log(AccidentalDamageToMachineryList);
        ...
        console.log(obj['BuildingSumInsuredFullcover'],obj['AccidentalDamageToMachinery'],obj['SolarGeyser'],obj['InHouseGeyser']);
        obj['filled'] = HouseOwnerPhoenix.length > 0 ? true : false;
        return obj
      }
    }
    getSaveDetails(entry,claimList,obj){
      ...
      if (entry.BuildingSumInsuredFullcover != 0 && entry.BuildingSumInsuredFullcover != null && entry.BuildingSumInsuredFullcover != '') {
        let subEntry = {
      ...
      if (entry.HomeownersLiability != 0 && entry.HomeownersLiability != null && entry.HomeownersLiability != '') {
        let subEntry = {
          "SectionId": "227","SectionName": "House Owners",
      ...
      if (entry.AccidentalDamageToMachinery != 0 && entry.AccidentalDamageToMachinery != null && entry.AccidentalDamageToMachinery != '' ) {
        let subEntry = {
          "SectionId": "227","SectionName": "House Owners",
      ...
      if (entry.SolarGeyser != 0 && entry.SolarGeyser != null && entry.SolarGeyser != '' ) {
        let subEntry = {
          "SectionId": "227","SectionName": "House Owners",
      ...
      if (entry.InHouseGeyser != 0 && entry.InHouseGeyser != null && entry.InHouseGeyser != '' ) {
        let subEntry = {
          "SectionId": "227","SectionName": "House Owners",
