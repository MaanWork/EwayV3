            ...
            fieldGroup: [
              {
                ...
                fieldGroup: [
                  {
                    className: 'col-12 md:col-6 lg:col-6 xl:col-6 pl-2 pr-2 pt-1 mt-2',
                    type: 'ngselect',
                    id: 'CustomerTitle',
                    key: 'Title',
                    hide: false,
                  ...
                  {
                    className: 'col-12 md:col-2 lg:col-2 xl:col-2 pl-2 pr-2 pt-1 mt-2',
                    type: 'ngselect',
                    id: 'CountryCode',
                    key: 'MobileCode',
                    templateOptions: {
                ...
                fieldGroup: [
                  ...
                  },
                  {
                    ...
                    templateOptions: {
                      ...
                      required: true,
                      disabled: this.checkDisable('TaxExemptedId'),
                      maxLength: 50
                    },
              ...
              },
              {
                ...
                fieldGroup: [
                  ...
                  {
                    className: 'col-12 md:col-3 lg:col-3 xl:col-3 pl-2 pr-2 pt-1 mt-2',
                    type: 'ngselect',
                    id: 'Country',
                    key: 'Country',
                    templateOptions: {
                  ...
                  },
                  {
                    ...
                    templateOptions: {
                      ...
                      required: false,
                      disabled: this.checkDisable('PoBox'),
                      maxLength: 150
                    },
