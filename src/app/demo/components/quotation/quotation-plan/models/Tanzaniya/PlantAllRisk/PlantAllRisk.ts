...
export class PlantAllRiskTanzaniya{
    customerDetails: any;
    commonDetails: any[]=[];
                    ...
                    fieldGroup: [
                      {
                        ...
                        fieldGroup: [
                          ...
                          //         disabled: this.checkDisable('PlantConstructionType'),
                          ...
                          // },
                          {
                            className: 'col-12 lg:col-3 md:col-3 xl:col-3 input-fixed-height',
                            type: 'primeTextArea',
                            key: 'PlantDescription',
                            props: {
                              label: `Description`,
                              maxLength: 15,
                              disabled: this.checkDisable('PlantDescription'),
                              required: true,
                              options: [],
                            },
                            validators: {
                          ...
                          },
                          {
                            ...
                            props: {
                              label: `Sum Insured`,
                              maxLength: 200,
                              disabled: this.checkDisable('PlantSumInsured'),
                              required: true,
                              options: [],
                            },
                            validators: {
