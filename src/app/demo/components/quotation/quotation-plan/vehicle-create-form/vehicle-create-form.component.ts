...
export class VehicleCreateFormComponent implements OnInit {
  ...
  constructor(private messageService: MessageService,private sharedService: SharedService,private appComp:AppComponent,
    ...
    this.insuranceId = this.userDetails.Result.InsuranceId;
      ...
      this.insuranceId = this.userDetails.Result.InsuranceId;
      if (sessionStorage.getItem('endorsePolicyNo')) {this.endorsementSection=true;}
  ...
  onSaveSearchVehicles(){
    ...
    let quoteStatus = sessionStorage.getItem('QuoteStatus');
      ...
      if(this.endorsementSection){
        let entry = JSON.parse(sessionStorage.getItem('endorseTypeId'))
          this.endorsementDate = entry?.EffectiveDate;
          this.endorsementEffectiveDate = entry?.EffectiveDate;
          this.endorsementRemarks = entry?.Remarks;
          this.endorsementType = entry?.EndtTypeId;
          this.endorsementTypeDesc = entry?.EndtName;
          this.endtCategoryDesc = entry?.Category;
          ...
          this.orginalPolicyNo = entry?.PolicyNo;
      ...
      if(commonDetails){
        ...
        this.BusinessSource=commonDetails.BusinessSource;
        this.businessSourceCode=commonDetails.BusinessSourceId;
  ...
  onProceed(){
    ...
    if(this.insuranceId=='100046' || this.insuranceId=='100047' || this.insuranceId=='100049' || this.insuranceId=='100050'){
        if(this.bodyType=='P'){this.grossWeight=null;}
        else{this.engineCapacity=null;}
    }
    if(this.insuranceId=='100048')  this.engineCapacity=null;
    let ReqObj = {
      "Insuranceid": this.insuranceId,
      "BranchCode": this.branchCode,
