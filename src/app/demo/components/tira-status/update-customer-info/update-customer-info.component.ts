...
export class UpdateCustomerInfoComponent implements OnInit {
    ...
    messages: Message[] = [];
      ...
      shows: boolean=false;final:boolean=false;endorsementId:any=null;
        ...
        let policyNo=sessionStorage.getItem('currentPolicyNo');
         if(policyNo){this.setValues(policyNo)}
        this.getTaxExcepted();
        }
        getHeaders(codeDesc){
        ...
        public async onSubmit(data) {
            ...
            let ReqObj = {
                ...
                "QuoteNo": sessionStorage.getItem('currentQuoteNo')
            }
        ...
        setValues(policyNo) {
            ...
            let urlLink = `${this.CommonApiUrl}tira/getpersonalinfo`;
            this.sharedService.onPostMethodSync(urlLink, ReqObj).subscribe(
                (data: any) => {
                    if (data.Result) {
                        ...
                        this.customerReferenceNo = customerDetails?.CustomerReferenceNo
